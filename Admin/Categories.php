...
require_once __DIR__ . '/Assets/Functions/CategoriesFunctions.php';
  ...
  <div class="recent__grid">
    <div class="grid__card">
      ...
      <div class="card__header">
        <h3>Catégories de plats : <span id="nbcats"><?= countCat($pdo) ?></span></h3>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Ajouter Catégorie de plat</h5>
      ...
      <div class="modal-body">
        <form action="" method="post" enctype="multipart/form-data" id="add_cat_form">
          ...
          <?php if ($options['show_cat_description']) : ?>
            <div class="mb-3 mt-4">
          ...
          <?php if ($options['show_cat_pieces']) : ?>
            <div class="mb-3 mt-4">
              <label for="add_pieces" class="form_label">Nombre de pieces : </label>
              <input type="number" name="add_pieces" id="add_pieces" class="form-control">
            </div>
          <?php endif; ?>

          <?php if ($options['show_cat_photo']) : ?>
            <div class="mb-3 mt-4">
...
<div class="modal fade" id="deletemodal">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Suppresion Categorie</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
