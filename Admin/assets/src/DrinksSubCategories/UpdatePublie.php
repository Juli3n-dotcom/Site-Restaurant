...
Update de la publication d'une sous categories a partir  DrinksSub.php en Ajax
...
if (!empty($_POST)) {
  ...
  if ($publie == 0) {
    ...
    $req = $pdo->prepare('UPDATE boissons_sous_categories SET est_publie = :publie WHERE id = :id');
