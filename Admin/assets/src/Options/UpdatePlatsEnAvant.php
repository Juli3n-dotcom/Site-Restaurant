...
Gestion de l'affichage de la mise en avant des plats
...
if (!empty($_POST)) {
  ...
  if ($publie == 0) {
    ...
    $req = $pdo->prepare('UPDATE options SET show_plat_en_avant = :publie');
    ...
    postJournal($pdo, $user, 0, 'Modification d\'option', 'Affichage de la mise en avant des plats');
    ...
    postJournal($pdo, $user, 0, 'Modification d\'option', 'Retrait de la mise en avant des plats');
