...
Gestion de l'affichage des stats des plats
...
if (!empty($_POST)) {
  ...
  if ($publie == 0) {
    ...
    $req = $pdo->prepare('UPDATE options SET show_plat_stats = :publie');
    ...
    postJournal($pdo, $user, 0, 'Modification d\'option', 'Affichage des stats des plats');
    ...
    postJournal($pdo, $user, 0, 'Modification d\'option', 'Retrait des stats des plats');
