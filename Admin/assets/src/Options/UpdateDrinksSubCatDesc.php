...
if (!empty($_POST)) {
  ...
  if ($publie == 0) {
    ...
    $req = $pdo->prepare('UPDATE options SET show_sub_cat_drink_description = :publie');
    ...
    postJournal($pdo, $user, 0, 'Modification d\'option', 'Affichage des description des sous catégories de boissons');
    ...
    postJournal($pdo, $user, 0, 'Modification d\'option', 'Retrait des description des sous catégories de boissons');
