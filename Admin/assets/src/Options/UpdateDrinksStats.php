...
Gestion de l'affichage des stats des boissons
...
if (!empty($_POST)) {
  ...
  if ($publie == 0) {
    ...
    $req = $pdo->prepare('UPDATE options SET show_drinks_stats = :publie');
    ...
    postJournal($pdo, $user, 0, 'Modification d\'option', 'Affichage des stats des boissons');
    ...
    postJournal($pdo, $user, 0, 'Modification d\'option', 'Retrait des stats des boissons');
