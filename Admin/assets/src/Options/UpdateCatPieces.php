...
Gestion de l'affichage des du nombre de pieces des categories
...
if (!empty($_POST)) {
  ...
  if ($publie == 0) {
    ...
    $req = $pdo->prepare('UPDATE options SET show_cat_pieces = :publie');
    ...
    postJournal($pdo, $user, 0, 'Modification d\'option', 'Affichage du nombre de pieces de catégories de plats');
    ...
    postJournal($pdo, $user, 0, 'Modification d\'option', 'Retrait du nombre de pieces de catégories de plats');
