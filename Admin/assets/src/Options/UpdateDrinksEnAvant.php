...
Gestion de l'affichage de la mise en avant des boissons
...
if (!empty($_POST)) {
  ...
  if ($publie == 0) {
    ...
    $req = $pdo->prepare('UPDATE options SET show_drinks_en_avant = :publie');
    ...
    postJournal($pdo, $user, 0, 'Modification d\'option', 'Affichage des options de mise en avant des boissons');
    ...
    postJournal($pdo, $user, 0, 'Modification d\'option', 'Retrait des options de mise en avant des boissons');
