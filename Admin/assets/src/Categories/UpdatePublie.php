...
Update de la publication d'une categories a partir categorie.php en Ajax
...
if (!empty($_POST)) {
  ...
  if ($publie == 0) {
    ...
    $req = $pdo->prepare('UPDATE plats_categories SET est_publie = :publie WHERE id = :id');
    ...
    while ($row = $query->fetch()) {
      ...
      $result['resultat'] .= '<tr draggable="false">';
