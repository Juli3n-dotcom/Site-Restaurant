$(document).ready(function () {
  ...
  */
  ...
  function load_data(page) {
    ...
    $.ajax({
      url: "Assets/Src/DrinksCategories/AffichageCategories.php",
      method: "post",
      data: { page: page },
...
$("#add_cat_form").on('submit', function(e){
  e.preventDefault();
    ...
    $.ajax({
      ...
      type: 'POST',
      url: 'Assets/Src/DrinksCategories/AddCategories.php',
...
$(document).on('click','.viewbtn', function(){  
  ...
  $.ajax({  
       url:"Assets/Src/DrinksCategories/ViewCategorie.php",  
       method:"post",  
       data:{cat_id:cat_id},  
       success:function(data){  
...
$('#delete_cat').on('submit', function(e){
  ...
  function delete_cat(){
    ...
    $.post('Assets/Src/DrinksCategories/DeleteCategorie.php', parameters, function(data){
 ...
 */
 ...
 $(document).on('click','.editbtn', function(){  
    var cat_id = $(this).attr("id");  
    $.ajax({  
         url:"Assets/Src/DrinksCategories/ModalUpdateCategories.php",  
         method:"post",  
         data:{cat_id:cat_id},  
         success:function(data){  
...
$(document).on('submit', '#update_cat', function(e){
  ...
  $.ajax({
    ...
    type: 'POST',
    url: 'Assets/Src/DrinksCategories/UpdateCategories.php',
    data: new FormData(this),
    dataType: 'json',
    contentType: false,
    cache: false,
...
// # traitement de la publication
 $(document).on('click', '.est_publie', function(e){
  ...
  function update_est_publie(){
    ...
    $.post('Assets/Src/DrinksCategories/UpdatePublie.php', parameters, function(data){
 ...
 */
  ...
  $('#table').sortable({
    ...
    update: function (event, ui) {
      ...
      $.ajax({  
        url:"Assets/Src/DrinksCategories/UpdatePositionCategories.php",  
        method: "POST", 
        dataType: 'JSON',
        data: {data: data},  
        success: function (data) {  
