$(document).ready(function () { 
  ...
  */
  ...
  function load_data(page) {
    ...
    $.ajax({
      url: "Assets/Src/DrinksSubCategories/AffichageSousCategories.php",
      method: "post",
      data: { page: page },
...
$("#add_cat_form").on('submit', function(e){
  ...
  e.preventDefault();
    ...
    $.ajax({
      ...
      type: 'POST',
      url: 'Assets/Src/DrinksSubCategories/AddSousCategories.php',
      ...
      success: function(data){
        ...
        if (data.status == true) {   
          ...
          $('#addmodal').modal('hide');
          $('#nbdrinkcat').html(data.nbdrinkcat);
...
$(document).on('click','.viewbtn', function(){  
  ...
  $.ajax({  
       url:"Assets/Src/DrinksSubCategories/ViewSousCategorie.php",  
       method:"post",  
       data:{cat_id:cat_id},  
       success:function(data){  
...
$('#delete_cat').on('submit', function(e){
  ...
  function delete_cat(){
    ...
    $.post('Assets/Src/DrinksSubCategories/DeleteSousCategories.php', parameters, function(data){
 ...
 */
 ...
 $(document).on('click','.editbtn', function(){  
    ...
    $.ajax({  
         url:"Assets/Src/DrinksSubCategories/ModalUpdateSousCategories.php",  
         method:"post",  
         data:{cat_id:cat_id},  
         success:function(data){  
...
$(document).on('submit', '#update_cat', function(e){
  ...
  $.ajax({
    ...
    type: 'POST',
    url: 'Assets/Src/DrinksSubCategories/UpdateSousCategories.php',
    data: new FormData(this),
    dataType: 'json',
    contentType: false,
    cache: false,
...
// # traitement de la publication
 $(document).on('click', '.est_publie', function(e){
  ...
  function update_est_publie(){
    ...
    $.post('Assets/Src/DrinksSubCategories/UpdatePublie.php', parameters, function(data){
 ...
 */
  ...
  $('#table').sortable({
    ...
    update: function (event, ui) {
      ...
      $.ajax({  
        url:"Assets/Src/DrinksSubCategories/UpdatePositionSousCategories.php",  
        method: "POST", 
        dataType: 'JSON',
        data: {data: data},  
        success: function (data) {  
