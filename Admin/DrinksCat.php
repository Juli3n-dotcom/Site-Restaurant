...
require_once __DIR__ . '/Assets/Functions/DrinksCategoriesFunctions.php';

$page_title = 'Catégories de Boissons';
$ua = getBrowser();
  ...
  <div class="recent__grid">
    <div class="grid__card">
      ...
      <div class="card__header">
        <h3><?= $page_title ?> : <span id="nbdrinkcat"><?= countCat($pdo) ?></span></h3>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Ajouter Catégorie de boissons</h5>
      ...
      <div class="modal-body">
        <form action="" method="post" enctype="multipart/form-data" id="add_cat_form">
          ...
          <?php if ($options['show_cat_drink_photo']) : ?>
            <div class="mb-3 mt-4">
